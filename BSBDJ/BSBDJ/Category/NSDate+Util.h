 ...
 *  判断2个字符串类型的日期大小
 *
 *  @param timeStr       第一个日期字符串
 *  @param secondTimeStr 第二个日期字符串
 *  @param formatter     日期的格式:"yyyy-MM-dd HH:mm:ss"
 *
 *  @return 返回值为int类型 0 相等 -1第一个在第二个以前 1第一个在第二个以后
 */
